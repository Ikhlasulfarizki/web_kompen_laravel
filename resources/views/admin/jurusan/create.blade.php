    ...
    <div class="bg-white rounded-lg shadow-lg p-8 max-w-md mx-auto">
        <form action="{{ route('admin.jurusan.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="nama_jurusan" name="nama_jurusan" value="{{ old('nama_jurusan') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 @error('nama_jurusan') border-red-500 @enderror">
                @error('nama_jurusan')
