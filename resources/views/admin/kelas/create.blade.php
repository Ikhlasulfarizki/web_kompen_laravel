...
<div class="p-8">
    ...
    <div class="bg-white rounded-lg shadow-lg p-8 max-w-md mx-auto">
        <form action="{{ route('admin.kelas.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="nama_kelas" name="nama_kelas" value="{{ old('nama_kelas') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 @error('nama_kelas') border-red-500 @enderror">
                @error('nama_kelas')
    ...
    <script>
        ...
        // Trigger change event jika ada nilai old di jurusan
