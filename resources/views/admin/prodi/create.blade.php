    ...
    <div class="bg-white rounded-lg shadow-lg p-8 max-w-md mx-auto">
        <form action="{{ route('admin.prodi.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="nama_prodi" name="nama_prodi" value="{{ old('nama_prodi') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 @error('nama_prodi') border-red-500 @enderror">
                @error('nama_prodi')
