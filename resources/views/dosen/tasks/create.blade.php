...
<div class="max-w-3xl mx-auto px-4 py-8">
    <h2 class="text-3xl font-bold text-gray-800 mb-6">Buat Task Baru</h2>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('dosen.tasks.store') }}" method="POST">
            @csrf
            ...
            <div class="mb-4">
                ...
                <textarea id="deskripsi" name="deskripsi" rows="3"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 @error('deskripsi') border-red-500 @enderror">{{ old('deskripsi') }}</textarea>
                @error('deskripsi')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="date" id="tanggal_waktu" name="tanggal_waktu" value="{{ old('tanggal_waktu') }}" required
            ...
            <div class="mb-4">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <input type="number" id="jam" name="jam" value="{{ old('jam', 0) }}" required min="0" max="24"
                ...
                <p class="text-gray-500 text-sm mt-2">Contoh: 2 jam 30 menit</p>
            </div>
            ...
            <div class="flex gap-3">
                <a href="{{ route('dosen.tasks.index') }}" class="px-6 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400">
                    Batal
                </a>
